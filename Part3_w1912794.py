    ...
    for i in range(100):         
        ...
        if tot != 120:
            ...
            if c_pass == 120:
                ...
                progre = []
                progress.append('*')
                progre.append(c_pass)
                progre.append(c_defer)
                progre.append(c_fail)
                main1.append(progre)
                ...
                retrie = []
                retriever.append('*')
                retrie.append(c_pass)
                retrie.append(c_defer)
                retrie.append(c_fail)
                main3.append(retrie)
