...
def version2():     # This function is to input many number of user inputs....Staff version
    ...
    fo=open('text.txt','w')     # Opening a new Text Eile
    for i in range(100):
        ...
        if tot != 120:
            ...
            if c_pass == 120:
                ...
                pro_count += 1
                progress.append('*')
                fo.write('Progress :'+str(c_pass)+','+str(c_defer)+','+str(c_fail)+'\n')
                ...
                trail_count += 1
                trailer.append('*')
                fo.write('progress (module trailer) :'+str(c_pass)+','+str(c_defer)+','+str(c_fail)+'\n')
                ...
                retri_count += 1
                retriever.append('*')
                fo.write('Module retriever :'+str(c_pass)+','+str(c_defer)+','+str(c_fail)+'\n')
                ...
                exclu_count += 1
                excluded.append('*')
                fo.write('Excluded :'+str(c_pass)+','+str(c_defer)+','+str(c_fail)+'\n')
    ...
    print('progress   '' trailer   '' retriever   '' excluded')     # Printing Vertical Histogram
...
# printing the list from the Text file
